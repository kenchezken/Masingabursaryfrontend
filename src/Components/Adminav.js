    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start rtl:justify-end">
        <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" className="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
          ...
          <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Masinga Admin Dashboard</span>
  ...
  <ul className="space-y-2 font-medium">
    ...
    <li>
      ...
      >
        ...
        <span className="flex-1 ms-3 whitespace-nowrap">Graphical Analysis</span>
      </NavLink>
    </li>
    <li>
      <NavLink
      ...
      >
        ...
        <span className="flex-1 ms-3 whitespace-nowrap">Search student</span>
      </NavLink>
    </li>
  </ul>
</div>
